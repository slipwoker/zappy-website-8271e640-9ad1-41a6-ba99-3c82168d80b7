...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!window.zappyContactFormLoaded || window.zappyContactFormLoaded) {
        (async function() {
          try {
            console.log('📧 Zappy: Sending contact form to backend...');
            
            const zappyPayload = {
              websiteId: '8271e640-9ad1-41a6-ba99-3c82168d80b7',
              name: name,
              email: email,
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Raki Beauty uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
